...
<form action="">
	<table border=2> 
		...
		<c:forEach items="${userlist}" var="user1">
			...
			<td><input type="checkbox" name="deletemultiple" value="${user1.mail}"/></td>
			<td><input type="button" value="Edit" onclick="editUser('${user1.mail}')" /> </td>    
			<td><input type="button" value="Delete"
						onclick="deleteemployee('${user1.mail}')" /></td>        
           <%--  <td><input type="button"Delete" onclick="deleteUser('${user1.mail}')" /> </td></tr> --%>
		</c:forEach>
	</table>
	</form>
</body>
